...
const LIGHT_SEMANTIC: Record<string, string> = {
  ...
  "--sjs-special-background": "#E2E8F0",
  "--sjs-layer-1-background-500": "#FFFFFF",
  "--sjs-layer-1-background-400": "#F1F5F9",
  "--sjs-layer-1-foreground-100": "rgba(15, 23, 42, 0.9)",
  "--sjs-layer-1-foreground-75": "rgba(15, 23, 42, 0.75)",
  "--sjs-layer-1-foreground-50": "rgba(15, 23, 42, 0.5)",
  "--sjs-secondary-background-500": CREATOR_BRAND,
  "--sjs-secondary-background-400": CREATOR_BRAND_LIGHT,
  "--sjs-secondary-background-25": "rgba(0, 51, 153, 0.22)",
  "--sjs-secondary-background-10": "rgba(0, 51, 153, 0.08)",
  "--sjs-primary-background-500": CREATOR_BRAND,
  "--sjs-primary-background-10": "rgba(0, 51, 153, 0.08)",
  "--ctr-survey-page-background-color-hovered": "#FFFFFF",
  "--ctr-survey-page-background-color-selected": "#FFFFFF",
  "--lbr-question-panel-background-color": "#FFFFFF",
  "--ctr-survey-question-panel-border-color-hovered": "rgba(0, 51, 153, 0.35)",
  "--ctr-survey-question-panel-border-color-selected": CREATOR_BRAND,
  "--ctr-survey-page-border-color-hovered": "rgba(0, 51, 153, 0.35)",
  "--ctr-survey-page-border-color-selected": CREATOR_BRAND,
};
